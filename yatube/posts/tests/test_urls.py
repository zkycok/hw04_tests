...
class TaskURLTests(TestCase):
    ...
    def test_urls_author_users(self):
        """Доступность всех страниц для авторизованного пользователя-автора тестового поста"""
        templates_url_names = self.templates_url_names_public | self.templates_url_names_private
